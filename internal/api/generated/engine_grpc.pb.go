...
const (
	...
	Engine_UpsertRunStep_FullMethodName  = "/rocketship.v1.Engine/UpsertRunStep"
...
type EngineClient interface {
	...
	UpsertRunStep(ctx context.Context, in *UpsertRunStepRequest, opts ...grpc.CallOption) (*UpsertRunStepResponse, error)
	// Server Discovery
...
func (c *engineClient) UpsertRunStep(ctx context.Context, in *UpsertRunStepRequest, opts ...grpc.CallOption) (*UpsertRunStepResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpsertRunStepResponse)
	err := c.cc.Invoke(ctx, Engine_UpsertRunStep_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EngineServer interface {
	...
	UpsertRunStep(context.Context, *UpsertRunStepRequest) (*UpsertRunStepResponse, error)
	// Server Discovery
...
func (UnimplementedEngineServer) AddLog(context.Context, *AddLogRequest) (*AddLogResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AddLog not implemented")
}
...
func (UnimplementedEngineServer) WaitForCleanup(context.Context, *WaitForCleanupRequest) (*WaitForCleanupResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method WaitForCleanup not implemented")
}
func (UnimplementedEngineServer) UpsertRunStep(context.Context, *UpsertRunStepRequest) (*UpsertRunStepResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertRunStep not implemented")
}
...
func _Engine_UpsertRunStep_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpsertRunStepRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EngineServer).UpsertRunStep(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Engine_UpsertRunStep_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EngineServer).UpsertRunStep(ctx, req.(*UpsertRunStepRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Engine_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpsertRunStep",
			Handler:    _Engine_UpsertRunStep_Handler,
		},
		{
